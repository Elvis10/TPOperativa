...
public class MatrixObject
{
    ...
    protected Map<String, Map<String,Object> > matrix = new LinkedHashMap<>(); // representacion de la matriz, accedida por clases hijas
    protected List<String> items;
    
    public MatrixObject(List<String> items) //recibe una lista de los items que componen la matriz, al ser simetrica, van a tener las mismas filas que columnas
    {
        this.items = items;
    ...
    public void add(String row,String colum,Object value)
    {
        Map<String,Object> ref = this.matrix.get(row);
    ...
    public Object get(String row,String colum)
    {
